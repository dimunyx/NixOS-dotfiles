...
hl.bind(mod .. " + SPACE", hl.dsp.exec_cmd("qs ipc call appLauncher apps"))
hl.bind(mod .. " + V", hl.dsp.exec_cmd("qs ipc call appLauncher clip"))
hl.bind(mod .. " + SHIFT + V", hl.dsp.exec_cmd("qs ipc call appLauncher clipClear"))
hl.bind(mod .. " + R", hl.dsp.exec_cmd("qs ipc call appLauncher cmd"))
hl.bind(mod .. " + CTRL + W", hl.dsp.exec_cmd("qs ipc call appLauncher windows"))
hl.bind(mod .. " + L", hl.dsp.exec_cmd("qs ipc call session lock"))
hl.bind(mod .. " + N", hl.dsp.exec_cmd("qs ipc call notifications toggle"))
hl.bind(mod .. " + SHIFT + N", hl.dsp.exec_cmd("qs ipc call notifications dnd"))
hl.bind(mod .. " + ESCAPE", hl.dsp.exec_cmd("qs ipc call session toggle"))
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("qs ipc call volume volMute"))
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("qs ipc call volume volDown"))
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("qs ipc call volume volUp"))
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("qs ipc call volume micMute"))
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("qs ipc call brightness brightUp"))
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("qs ipc call brightDown"))
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("qs ipc call media playPause"))
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("qs ipc call media playPause"))
hl.bind("XF86AudioStop", hl.dsp.exec_cmd("qs ipc call media pause"))
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("qs ipc call media previous"))
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("qs ipc call media next"))
